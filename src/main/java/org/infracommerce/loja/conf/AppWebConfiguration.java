...
import org.infracommerce.loja.controllers.HomeController;
...
public class AppWebConfiguration extends WebMvcConfigurerAdapter{
	...
	public FormattingConversionService mvcConversionService(){
	 ...
	 public ViewResolver contentNegociationViewResolver(ContentNegotiationManager manager){
		 ...
		 viewResolvers.add(new JasonViewResolver());
	...
	public void configureDefaultServletHandling(DefaultServletHandlerConfigurer configurer) {
	 ...
	 public MailSender mailSender(){
	     ...
	     mailSender.setUsername("hashimotodiego@hotmail.com");
	     mailSender.setPassword("H@shimot3");
